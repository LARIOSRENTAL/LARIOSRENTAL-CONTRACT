...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    console.log(JSON.stringify({event:"renthub_booking_create",endpoint:"partner_freesale",contract_number:c.contract_number,group:map.group,partner_category_id:map.model,resource:"freesale",pm_prev_mezzo_id:"",pm_current_model_id:map.model,pickup:map.pickup,dropoff:map.dropoff,has_pickup_address:!!pickupAddress,has_dropoff_address:!!dropoffAddress,price_override:rentalGross>0}));
