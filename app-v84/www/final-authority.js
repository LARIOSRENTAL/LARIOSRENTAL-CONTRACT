...
function installOperationsPanels(){
  const modules=[['vehicle-manager-v1.js?v=4','vehicle-manager'],['pricing-manager-v1.js?v=3','pricing-manager'],['contract-download-v1.js?v=3','contract-download']];
...
function installAuthoritativeFlow(){
  ...
  s.src='pdf-authority-v3.js?authority=8&ts='+Date.now();
